...
The VIDEO database contains the data of a video rental store: customer information, details about the movies, and the companies. It also records who has rented which movie.
